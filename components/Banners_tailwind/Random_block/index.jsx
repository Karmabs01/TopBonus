        ...
        <div className="main__container">
          {loading ? (
            ...
            <div className="relative py-16">
              <div className="absolute inset-x-0 top-0 hidden h-1/2 bg-gray-100 lg:block" aria-hidden="true" />
              <div className="mx-auto max-w-7xl bg-indigo-600 lg:bg-transparent lg:px-8">
                <div className="lg:grid lg:grid-cols-12">
                  <div className="relative z-10 lg:col-span-4 lg:col-start-1 lg:row-start-1 lg:bg-transparent lg:py-16">
                    <div className="absolute inset-x-0 h-1/2 bg-gray-100 lg:hidden" aria-hidden="true" />
                    <div className="mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-none lg:p-0">
                      <div className="aspect-h-6 aspect-w-10 sm:aspect-h-1 sm:aspect-w-2 lg:aspect-w-1">
                        <img className="rounded-3xl object-cover object-center shadow-2xl bg-teal-600" src="#" alt="" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative bg-indigo-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
                    ...
                    <div className="relative mx-auto max-w-md space-y-6 px-6 py-12 sm:max-w-3xl sm:py-16 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
                      <h2 className="text-3xl font-bold tracking-tight text-white" id="join-heading">Lorem, ipsum.</h2>
                      <p className="text-lg text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea eveniet numquam nam incidunt, asperiores quo. Perspiciatis exercitationem alias voluptatum modi.</p>
                      <a className="block w-full rounded-md border border-transparent bg-white px-5 py-3 text-center text-base font-medium text-indigo-700 shadow-md hover:bg-gray-50 sm:inline-block sm:w-auto" href="#">Try Your Luck!</a>
                    </div>
                  </div>
                </div>
              </div>
