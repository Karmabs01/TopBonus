...
const _tagged_template_literal_loose = __turbopack_require__("[project]/node_modules/next/node_modules/@swc/helpers/cjs/_tagged_template_literal_loose.cjs (ecmascript, app)");
    ...
    return frames.map((frame)=>{
        try {
            ...
            if (res) {
                ...
                const distDir = (_process_env___NEXT_DIST_DIR = ("TURBOPACK compile-time value", JSON.parse('"/home/anderson/projects/TPBONUS/TopBonus/.next"'))) == null ? void 0 : (_process_env___NEXT_DIST_DIR_replace = _process_env___NEXT_DIST_DIR.replace(/\\/g, "/")) == null ? void 0 : _process_env___NEXT_DIST_DIR_replace.replace(/\/$/, "");
                if (distDir) {
